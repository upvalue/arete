...
CXXFLAGS := $(CXXFLAGS) -DNATIVE_VM_ENABLE=$(NATIVE_VM_ENABLE) -DNATIVE_VM_DEFAULT=$(NATIVE_VM_DEFAULT) -DNATIVE_VM_ONLY=$(NATIVE_VM_ONLY)
ECXXFLAGS := $(ECXXFLAGS) -DNATIVE_VM_ENABLE=$(NATIVE_VM_ENABLE) -DNATIVE_VM_DEFAULT=$(NATIVE_VM_DEFAULT) -DNATIVE_VM_ONLY=$(NATIVE_VM_ONLY)
...
heap.boot: bin/arete $(CXXOBJS) $(SSRC) 
	$(call colorecho, "IMG $@ ")
	bin/arete boot.scm --save-image $@

heap32.boot: bin/arete32 $(SSRC) 
	$(call colorecho, "IMG $@ ")
	bin/arete32 boot.scm --save-image $@
